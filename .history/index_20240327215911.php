...
.grid-container {
  ...
  display: grid;
  grid-template-columns: auto 300px 500px auto 300px ;
            ...
            <div class="first">
                ...
                <div class="condition">
                    ...
                    <div class="radio-group">
                        <input type="radio" name="date" value="">全部(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="1day">當天來回(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="2days">兩日遊(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="3days">三日遊(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="4days">四天~六天(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="7days">七天~九天(0)<br>
                        </div>
                        <div class="radio-group">
                        <input type="radio" name="date" value="10days">十天以上(0)<br>
                        </div>
                    </div>
                    <div>
                        <div class="radio-group">
                            <label>日期</label>
                            <input type="radio" name="sex" value="">不拘
                        </div>
                        <div class="radio-group">
                        ...
                        <div>
                            <div class="radio-group">
                                <label>技能</label>
                                <input type="radio" name="skill" value="">不拘
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="skill" value="car">開車
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="skill" value="motorcycle">騎車
                            </div>
                        </div>
                        <div>
                            <div class="radio-group">
                                <label>人數</label>
                                <input type="radio" name="NOpeople" value="">不拘
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="NOpeople" value="two">2~4人
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="NOpeople" value="five">5~7人
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="NOpeople" value="eight">8~10人
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="NOpeople" value="tenOver">10人以上
                            </div>
                        </div>
                        <div>
                            <div class="radio-group">
                                <label>年齡</label>
                                <input type="radio" name="age" value="">不拘
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="2000">00後(2000~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1990">九0後(1990~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1980">八0後(1980~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1970">七0後(1970~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1960">六0後(1960~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1950">五0後(1950~)
                            </div>
                            <div class="radio-group">
                                <input type="radio" name="age" value="1949">五0前(~1949)
                            </div>
                        </div>
